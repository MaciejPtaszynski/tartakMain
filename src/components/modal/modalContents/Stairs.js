...
import img1 from "../../../library/schody1.webp";
import img2 from "../../../library/schody2.jpg";
  ...
  return (
    <Box style={modalStyle}>
      <Box style={modalContent}>
        ...
        <Typography p={5} sx={{lineHeight: 1.7}}>Wykonujemy różnego rodzaju stopnie i podstopnie z materiałów takich jak dąb, jesion, buk. Oferujemy także komleksowy montaż.
        Więcej informacji pod nr telefonu 534 916 564 lub mailowo jantartartak@gmail.com .
        </Typography>
