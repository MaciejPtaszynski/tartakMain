  ...
  return (
    <Box style={modalStyle}>
      <Box style={modalContent}>
        ...
        <Typography p={5} sx={{lineHeight: 1.5}}>Wykonujemy różnego rodzaju stopnie i podstopnie z materiałów takich jak
          dąb, jesion, buk. Oferujemy także komleksowy montaż.
